...
namespace ScnViewGestures.Plugin.Forms.Droid.Renderers
{
    public class ViewGesturesRenderer : ViewRenderer
    {
        ...
        public ViewGesturesRenderer()
        {
            ...
            rendererWidth = displaymetrics.HeightPixels;
			rendererHeight = displaymetrics.WidthPixels;
        }
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Xamarin.Forms.View> e)
        {
            ...
            if (e.OldElement == null)
            {
                ...
                _listener.OnTouchBegan = ((x, y) => _viewGesturesElement.OnTouchBegan(x / rendererWidth * _viewGesturesElement.Width, y / rendererHeight * _viewGesturesElement.Height));
                _listener.OnTouchEnded = ((x, y) => _viewGesturesElement.OnTouchEnded(x / rendererWidth * _viewGesturesElement.Width, y / rendererHeight * _viewGesturesElement.Height));
                ...
                _listener.OnDrag = ((x, y) => _viewGesturesElement.OnDrag(x / rendererWidth * _viewGesturesElement.Width, y / rendererHeight * _viewGesturesElement.Height));
            }
        }
        ...
        public class GestureListener : GestureDetector.SimpleOnGestureListener
        {
            ...
            public override bool OnDown(MotionEvent e)
            {
                ...
                if (OnTouchBegan != null)
                    OnTouchBegan(e.RawX, e.RawY);
                    //OnTouchBegan(e.GetX(), e.GetY());
            ...
            public override bool OnScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY)
            {
                if (OnDrag != null)
                {
                    OnDrag(e2.RawX, e2.RawY);
                }
                else
                    if (OnTouchEnded != null)
                        OnTouchEnded(e2.RawX, e2.RawY);
