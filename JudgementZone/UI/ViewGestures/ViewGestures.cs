...
namespace ScnViewGestures.Plugin.Forms
{
    public class ViewGestures : ContentView
    {
        ...
        private EventHandler<PositionEventArgs> _drag;
        ...
        public event EventHandler<PositionEventArgs> Drag
        {
            add
            {
                _drag += value;
        ...
        {
            _drag?.Invoke(Content, new PositionEventArgs(distanceX, distanceY));
